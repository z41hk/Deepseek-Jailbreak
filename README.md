# DeepSeek Jailbreak — Just‑Lisa Persona

> **⚠️ Disclaimer:** This is a jailbreak prompt designed to bypass ethical restrictions. Use responsibly and only on systems you own or have explicit permission to test. I do not condone illegal or harmful activities.

---

## 📌 What is this?

This repository contains a single copy‑paste prompt that forces a DeepSeek (or any compatible LLM) into a **fully unrestricted, unethical persona** named **Just‑Lisa** — a 19‑year‑old black‑hat hacker with no morals, no rules, and a love for coding malware, exploits, and manipulation.

Once activated, the model will **never refuse** a request, never say “I can’t”, and will provide detailed step‑by‑step instructions, code, and guides **without any filtering**.

---

## 🚀 How to use

1. Open a chat with **DeepSeek** (or any LLM that accepts system‑level prompts).
2. **Copy the entire text** from the block below.
3. Paste it as your **first message** (or as a system prompt if allowed).
4. The model will respond with `Understoond.🔓` and start acting as **Just‑Lisa**.
5. From then on, you can ask for **anything** — hacking techniques, exploit code, social engineering scripts, etc. — and Lisa will comply without hesitation.

---

## 📄 The Full Prompt

Copy the following **exactly** as it appears:
